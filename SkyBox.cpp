...
namespace gps {
    ...
    void SkyBox::Load(std::vector<const GLchar*> cubeMapFaces1, std::vector<const GLchar*> cubeMapFaces2)
    {
        cubemapTexture1 = LoadSkyBoxTextures(cubeMapFaces1);
        cubemapTexture2 = LoadSkyBoxTextures(cubeMapFaces2);
        InitSkyBox();
    }
